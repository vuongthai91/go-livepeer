...
func (orch *orchestrator) ServeTranscoder(stream net.Transcoder_RegisterTranscoderServer, maxSessions int) {
	orch.node.serveTranscoder(stream, maxSessions)
}
...
func NewRemoteTranscoder(n *LivepeerNode, stream net.Transcoder_RegisterTranscoderServer, maxSessions int) *RemoteTranscoder {
